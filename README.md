...
| ⏱️ **Timer**     | カウントダウンタイマー（プリセット機能付き） | 1.0.1      | なし     |
| ⏲️ **Stopwatch** | 精密時間計測（ラップタイム機能付き）         | 1.0.1      | なし     |
| 🐱 **Bongo Cat** | キー入力に反応するアニメーション             | 1.0.1      | pynput   |
...
25分作業-5分休憩-15分長休憩のポモドーロテクニックタイマー。

**機能:**
- 自動サイクル管理（作業→短休憩→作業→長休憩）
- 完了ポモドーロ数カウント
- 開始/一時停止/リセット機能
- ウィンドウ最前面固定
